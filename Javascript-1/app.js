...
//  alert(`Happy coding \n prevent this page from creating addtional dialoges`)

 // ----------------------Question 05 --------------------

//  alert(`Hello... I can Js throught my web brower's Console`);

//  console.log(`Hello... I can Js throught my web brower's Console`);
...
// let studentName = "Hammad";
// let studentAge = 17;
// let studentlearning = "Web and mobile application";
// alert("Student Name: " + studentName + "\nStudent Age: " + studentAge + "\nlearning: " + studentlearning);

// ---------- question 5 -------------

// let alertMessage = "This is a single variable alert!";
// alert(alertMessage);

// ---------- question 6 -------------

// let email = "hammadshinwari377@gmail.com";
// alert("My email address is: " + email);

// ---------- question 7 -------------

// let book = "A smarter way to learn javascript";
// alert("I am currently reading the book titled:\n" + book);
...
// let specialCharacters = "▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬";
// alert(specialCharacters);
// document.write(specialCharacters);
...
//  document.write("Variable names can only contain,numbers,$, _.For example and :$my_1stvariable <br/>")
...
// document.write(`<br></br> substraction of ` + number2 + ` , ` + number1 + ` is ` + result);


// ----------------------Question 02 multiplication --------------------
...
// document.write(`<br></br> Multiplication of ` + number2 + ` by ` + number1 + ` is ` + result);
...
// document.write(`<br></br> division of ` + number2 + ` / ` + number1 + ` is ` + result);
...
// document.write(`<br></br> Modulus of ` + number2 + ` / ` + number1 + ` is ` + result);


// ----------------------Question 03 --------------------


// var message = `<br> value after variable declaration is undefined: ?? "`
...
// document.write( message , numbers , incrementNumber , addNumber , decrementNumber , remainderNumber )
...
// let tempInFarenheight = (tempInDegree * 9/5) + 32;
// document.write(tempInDegree,' C is ', tempInFarenheight,' F ' )

// document.write('<br>')

// let farenheightitem = 70;
// // C= (F * 9/5) + 32

// let celsius = (farenheightitem - 32) * 5 / 9;
// document.write(farenheightitem,' F is ', celsius,' C ' )
// document.write('<hr>')
